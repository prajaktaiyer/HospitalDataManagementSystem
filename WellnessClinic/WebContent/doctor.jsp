    ...
    <nav class="navbar navbar-expand-sm navbar-dark bg-dark navbar-fixed-top">
         <div class="container">
             ...
             <div class="collapse navbar-collapse" id="Navbar">
                 <ul class="navbar-nav">
                     <li class="nav-item"><a href="/WellnessClinic/doctorappointmentlist" class="nav-link">Appointments</a></li>
        ...
        <table border="1" cellpadding="5" id="patientTable" class="table table-bordered">
            ...
            <c:forEach var="patient" items="${listpatient}">
                <tr>
                    ...
                    <td>
                        <a href="/WellnessClinic/edit?id=<c:out value='${patient.patientId}' />">Edit</a>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="/WellnessClinic/delete?id=<c:out value='${patient.patientId}' />">Delete</a>                     
                    </td>
                </tr>
            </c:forEach>
